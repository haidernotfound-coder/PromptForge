...
const PLANS = [
  {
    ...
    features: ["Up to 50 prompts", "3 folders", "Basic search", "Community support"],
    cta: "Start free",
    highlighted: false,
  },
  {
  ...
  },
  {
    ...
    features: ["Everything in Pro", "Shared collections", "Role-based access", "Priority support"],
    cta: "Talk to us",
    highlighted: false,
  },
];

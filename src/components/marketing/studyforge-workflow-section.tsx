...
const STEPS = [
  {
    ...
    description: "Tell StudyForge what you're learning — a concept, a reading, or homework you're stuck on.",
  },
  {
    n: "02",
    title: "Generate",
    description: "Pick the right tool: Explain, Notes, Flashcards, Quiz, Homework Help, Planner, Summarize, or Exam Practice.",
  },
  {
    n: "03",
    title: "Review",
    description: "Drop into AI Study Chat to ask follow-ups or work through anything that's still unclear.",
  },
  {
    n: "04",
    title: "Retain",
    description: "Study with flashcards and quizzes generated straight from your own material.",
  },
];

export function StudyForgeWorkflowSection() {
  return (
      ...
      <div className="container py-24">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-3xl md:text-4xl font-semibold tracking-tight text-balance">
            From a rough topic to real retention
          </h2>
        </div>

...
export function PptForgeTopStatistics({ stats }: { stats: ScopedTopStats }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Generation activity</CardTitle>
          <CardDescription>PPTForge deck generation runs.</CardDescription>
        </CardHeader>
        <CardContent>
          <RankList entries={stats.topTools} empty="No PPTForge generations yet." />
        </CardContent>
      </Card>
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Most active users</CardTitle>
          <CardDescription>By total tracked PPTForge generations.</CardDescription>
        </CardHeader>
        <CardContent>
          <RankList entries={stats.mostActiveUsers} empty="No PPTForge activity yet." />
        </CardContent>
      </Card>
    </div>
  );

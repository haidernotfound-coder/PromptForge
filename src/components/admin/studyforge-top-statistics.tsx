...
export function StudyForgeTopStatistics({ stats }: { stats: ScopedTopStats }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Most used tools</CardTitle>
          <CardDescription>Across all 8 StudyForge tools + AI Study Chat.</CardDescription>
        </CardHeader>
        <CardContent>
          <RankList entries={stats.topTools} empty="No StudyForge tool runs yet." />
        </CardContent>
      </Card>
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Most active users</CardTitle>
          <CardDescription>By total tracked StudyForge actions.</CardDescription>
        </CardHeader>
        <CardContent>
          <RankList entries={stats.mostActiveUsers} empty="No StudyForge activity yet." />
        </CardContent>
      </Card>
    </div>
  );
